...
import { readJson, acknowledgeProviderWebhook } from "@/lib/webhooks";
 ...
 * pipeline passes as webhookUrl. Payload is only logged — pipelines poll for the result (SPEC §16.7).
 */
export async function POST(req: NextRequest) {
  ...
  return acknowledgeProviderWebhook("fal", json);
}
